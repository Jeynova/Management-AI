...
from app.controllers.speaker_controller import generate_biography, generate_biographies_bulk,regenerate_biography
...
def initialize_routes(app):
    ...
    # Génération IA : création d'une biographie pour les speakers
